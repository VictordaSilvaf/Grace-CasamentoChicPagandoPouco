                  ...
                  <div className="relative px-6 pt-8 sm:pt-16 md:pr-0 md:pl-16">
                    <div className="mx-auto max-w-2xl md:mx-0 md:max-w-none">
                      <div className="w-screen overflow-hidden rounded-tl-xl bg-gray-900">
                        ...
                        <div className="px-6 pt-6 pb-14 text-white max-w-2xl">
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, libero fuga? Obcaecati incidunt amet, architecto quia expedita officia sunt. Iste eum ipsum mollitia, dolores possimus molestias eveniet placeat architecto incidunt!
                        </div>
                      </div>
                    </div>
                    <div
