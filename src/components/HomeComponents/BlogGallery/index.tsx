    ...
    return (
        <div className="w-full pt-10">
            <div className="w-5xl mx-auto">
                ...
                <div className="flex flex-row justify-center mt-5 gap-3 items-center">
                    {categories.map((category) => (
                        <Fragment key={category.id}>
                            <Button key={category.id}
                                ...
                                className={`text-sm ${selectedCategory.id === category.id ? 'text-app-primary cursor-default' : 'text-app-typography-tertiary/50 hover:text-app-typography-tertiary'}`}
                            >
                                {category.name}
                            </Button>
...
const BlogGalleryItem = ({ image, title }: { image: string, title: string }) => {
    return (
        <Dialog>
